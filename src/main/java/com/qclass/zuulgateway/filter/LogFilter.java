...
/**
 * Created by fanwenwen on 2018/6/7.
 */
    ...
    public Object run() {
        try {
            ...
            if (map != null) {
                ...
                LogFilter.LOGGER.info(sb.toString());
            }
            // 打印请求json参数
            if (reqBbody != null) {
               LogFilter.LOGGER.info("request body:\t" + reqBbody);
            }
            ...
            if (outBody != null) {
                LogFilter.LOGGER.info("response body:\t" + outBody);
            }
